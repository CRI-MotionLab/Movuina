...
if [ -d /Library/Extensions/SiLabsUSBDriver64.kext ]; then
sudo kextunload /Library/Extensions/SiLabsUSBDriver64.kext
sudo rm -rf /Library/Extensions/SiLabsUSBDriver64.kext
fi
